...
* [zipkin](https://github.com/openzipkin/zipkin) 有侵入，无法监控JVM，没有APM功能 [![GitHub stars](https://img.shields.io/github/stars/openzipkin/zipkin.svg?style=social&label=Star&maxAge=2592000)](https://github.com/openzipkin/zipkin).
...
* [trino](https://github.com/trinodb/trino)  hadoop查询引擎 [![GitHub stars](https://img.shields.io/github/stars/trinodb/trino.svg?style=social&label=Star&maxAge=2592000)](https://github.com/trinodb/trino).

* [questdb](https://github.com/questdb/questdb)  实时数据库 [![GitHub stars](https://img.shields.io/github/stars/questdb/questdb.svg?style=social&label=Star&maxAge=2592000)](https://github.com/questdb/questdb).

* [pinot](https://github.com/apache/incubator-pinot) Pinot 从离线数据源（包括 Hadoop 和各类文件）和在线数据源（如 Kafka）中攫取数据进行分析 [![GitHub stars](https://img.shields.io/github/stars/apache/incubator-pinot.svg?style=social&label=Star&maxAge=2592000)](https://github.com/apache/incubator-pinot).
...
* [brickhouse](https://github.com/klout/brickhouse) HIVE的UDF [![GitHub stars](https://img.shields.io/github/stars/klout/brickhouse.svg?style=social&label=Star&maxAge=2592000)](https://github.com/klout/brickhouse).

* [KitDB](https://github.com/frost373/KitDB) 一个内嵌式持久型的 高速NoSQL存储 lib，以jar 包方式嵌入到应用中 [![GitHub stars](https://img.shields.io/github/stars/frost373/KitDB.svg?style=social&label=Star&maxAge=2592000)](https://github.com/frost373/KitDB).
...
* [librec](https://github.com/guoguibing/librec) JAVA推荐系统库 [![GitHub stars](https://img.shields.io/github/stars/guoguibing/librec.svg?style=social&label=Star&maxAge=2592000)](https://github.com/guoguibing/librec).
...
* [URL-Detector](https://github.com/linkedin/URL-Detector) 在一个长字符串里面快速检索URL [![GitHub stars](https://img.shields.io/github/stars/linkedin/URL-Detector.svg?style=social&label=Star&maxAge=2592000)](https://github.com/linkedin/URL-Detector).

* [kafka-streams-machine-learning-examples](https://github.com/kaiwaehner/kafka-streams-machine-learning-examples) 通过kafka进行机器学习 [![GitHub stars](https://img.shields.io/github/stars/kaiwaehner/kafka-streams-machine-learning-examples.svg?style=social&label=Star&maxAge=2592000)](https://github.com/kaiwaehner/kafka-streams-machine-learning-examples).
